...
tmux set-hook -g 'alert-bell[7811]' "run-shell -b '$plugin_dir/scripts/refresh_bells.py'"
tmux set-hook -g 'after-select-window[7812]' "run-shell -b '$plugin_dir/scripts/refresh_bells.py'"
